...
import ProfileButton from "@/components/shared-components/profile-button";
        ...
        <Link href="/">
          <div className={"flex items-center gap-4"}>
            ...
            <div>
              ...
              <p className={"leading-3 text-sm text-gray-400"}>
          ...
          {hasCart && (
            <CartDrawer>
              ...
              >
                ...
                <ArrowRightIcon
                  className={
                    "absolute w-5 right-5 transition -translate-x-2 duration-300 opacity-0 group-hover:opacity-100 group-hover:translate-x-0"
                  }
                ></ArrowRightIcon>
              </Button>
            </CartDrawer>
